...
import Label from "../../Label"; // plasmic-import: NOYDvolLp2vK/component
import TextInput from "../../TextInput"; // plasmic-import: G5eW64XjkUMh/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: GSVNRpawweNH/component
import Description from "../../Description"; // plasmic-import: c21-0lvcUPW9/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 8sD1wKk5YZ4K/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__g7SU, {
          [sty.freeBoxiconEnd__g7SUu4F]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__g7SUJcVJv]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__g7SUwQ7YC]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__e5D0V, {
            [sty.freeBoxiconStart__e5D0VJcVJv]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__e5D0VwQ7YC]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__aGpad)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__rPvCj, {
            [sty.freeBoxiconEnd__rPvCjU4F]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__rPvCjJcVJv]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lhMz8)}
                role={"img"}
              />
            ),
