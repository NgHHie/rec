...
import MenuPopover from "../../MenuPopover"; // plasmic-import: i0Yx26-6xGJm/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: l4PunEyhQIlC/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: b11CmpQWEEGt/icon
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__dJteF)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
