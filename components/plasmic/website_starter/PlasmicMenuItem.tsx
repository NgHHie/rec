...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: ZcTKxx0VOfaG/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tk7Cu)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__mbRiY)}>
            <div
              className={classNames(
                projectcss.all,
